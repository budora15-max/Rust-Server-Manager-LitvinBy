...
const DICT: Record<AppLocale, Record<WebhookEventKey, string>> = {
  ru: {
    ...
    testDesc: 'Интеграция с Rust Server Manager LitvinBY успешно настроена!',
    map: 'Карта',
    worldSize: 'Размер',
    seed: 'Сид',
    players: 'Игроки',
  ...
  en: {
    ...
    testDesc: 'Rust Server Manager LitvinBY integration has been configured successfully!',
    map: 'Map',
